...
DB_ENGINE = "mysql://pgonet:{}@%{DB_HOST}/pgonetdb_monocle".format(os.environ['POGOMAP_DB_PASS'])
#DB_ENGINE = 'postgresql://pgonet:{}@pgonetdb-monocle-postgresql.c8p581lg9jmq.us-west-2.rds.amazonaws.com/pgonetdb_monocle_postgresql'

AREA_NAME = 'TOKYO'     # the city or region you are scanning
...
SPEED_LIMIT = 30    # limit worker speed to this many SPEED_UNITs per hour
...
#BOUNDARIES = Polygon(((35.28374272801908,139.01241302490234),(35.278137436300966,138.99215698242188),(35.25739448366338,138.988037109375),(35.22823325064214,138.99181365966797),(35.2386091217919,139.01824951171875),(35.2330007075924,139.0374755859375),(35.20411123432421,139.02202606201172),(35.199061533096305,139.03713226318362),(35.23580496316437,139.0591049194336),(35.21617313851632,139.0876007080078),(35.2330007075924,139.11884307861325),(35.23973075809772,139.09343719482422),(35.27084997704059,139.03198242187497),(35.28374272801908,139.01241302490234)))
BOUNDARIES = Polygon((%{POLYGON}))

# key for Bossland's hashing server, otherwise the old hashing lib will be used
HASH_KEY = '%{HASH_KEY}'  # this key is fake
...
GOOGLE_MAPS_KEY = os.environ['POGOMAP_GMAPS_KEY']
...
CAPTCHA_KEY = os.environ['POGOMAP_CAPTCHA_KEY']
...
MANAGER_ADDRESS = ('0.0.0.0', %{MANAGER_PORT})  # could be used for CAPTCHA solving and live worker maps on remote systems
