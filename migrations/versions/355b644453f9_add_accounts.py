...
def upgrade():
    ...
    sa.Column('instance', sa.String(length=32), nullable=False),
    ...
    sa.Column('ban_reason', sa.String(length=12), nullable=True),
    ...
    op.create_index(op.f('ix_accounts_banned'), 'accounts', ['banned'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_accounts_banned'), table_name='accounts')
