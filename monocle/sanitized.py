...
_valid_types = {
    ...
    'CAPTCHA_KEY': str,
    'CLEANUP_LIMIT': int,
    'CLEANUP_RAIDS_OLDER_THAN_X_HR': float,
    'CLEANUP_SIGHTINGS_OLDER_THAN_X_HR': float,
    'CLEANUP_SPAWNPOINTS_OLDER_THAN_X_HR': float,
    'CLEANUP_FORT_SIGHTINGS_OLDER_THAN_X_HR': float,
    'CLEANUP_MYSTERY_SIGHTINGS_OLDER_THAN_X_HR': float,
    ...
    'SB_DETECTOR': bool,
    'SB_UNCOMMON_POKEMON_IDS': set_sequence,
    'SB_MAX_UNCOMMON_COUNT': Number,
    'SB_MIN_SIGHTING_COUNT': Number,
    'SB_QUARANTINE_SECONDS': Number,
    'SB_COOLDOWN': Number,
    'SB_WEBHOOK': str,
    'SCAN_DELAY': Number,
    'SEARCH_SLEEP': Number,
